...
Signal CSV: `reports/live_signals/closed_limit_up_signals_conservative_tpex_35adc734_2026-06-24.csv`
...
| --- | --- |
| planned_orders | 0.0 |
| evaluated_orders | 0.0 |
| missing_day1_data | 0.0 |
| invalid_price | 0.0 |
| gross_pnl | 0.0 |
| net_pnl | 0.0 |
| avg_net_return |  |
...
No planned paper orders were present in the signal CSV, so there is nothing to evaluate.
